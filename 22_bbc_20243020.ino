...
#define _DUTY_NEU 1640 // 1500
#define _DUTY_MIN 1050 // 1000

#define _SERVO_ANGLE_DIFF  69  // Replace with |D - E| degree
#define _SERVO_SPEED       60  // servo speed

#define _BANGBANG_RANGE    250  // duty up and down for bangbang control

// Target Distance
#define _DIST_TARGET    15 // Center of the rail (unit:mm)
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(50, 0.1, 0));
...
float volt_to_distance(int a_value)
{
  ...
  // return (6762.0 / (a_value - 9) - 4.0) * 10.0; 
    return 61.1 + -0.206*a_value + 1.74E-04 *a_value *a_value;
}
